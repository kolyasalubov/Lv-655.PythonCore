...
pygame.mouse.set_visible(False) # вимикаємо візуалізацію курсора
...
player_image = pygame.image.load(r"C:\Users\Easy\Desktop\PythonCore\Home_work\Lv-655.PythonCore\image\ufo.png").convert()
