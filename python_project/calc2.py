...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_equel.setGeometry(QtCore.QRect(240, 150, 60, 50))
        self.btn_dot = QtWidgets.QPushButton(self.centralwidget)
        self.btn_dot.setGeometry(QtCore.QRect(240, 200, 60, 50))
        font = QtGui.QFont()
        font.setFamily("Perpetua")
        font.setPointSize(15)
        font.setBold(True)
        ...
        self.btn_dot.setStyleSheet("background-color: rgb(170, 170, 255);")
        self.btn_dot.setLocale(QtCore.QLocale(QtCore.QLocale.Russian, QtCore.QLocale.Ukraine))
