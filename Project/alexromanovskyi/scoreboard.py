...
class Scoreboard:
    ...
    def __init__(self, ai_game):
        """Ініціалізація атрибутів, повязаних із рахуком"""
    ...
    def show_score(self):
        """Показати на екрані рахунок, кількість кораблів та рівень"""
    ...
    def prep_high_score(self):
        ...
        # Відцентрувати рекорд по горозонталі
    ...
    def check_high_score(self):
        """ Перевірити, чт встановлено новий рекорд"""
